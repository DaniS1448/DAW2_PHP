...
<body>
	...
	<br />
		...
		<b>Múltiple:</b> <br /> 
		<label for="codigos">Ciudades:</label>
		<!-- Se declara el nombre terminado en [] para tratarlo en PHP como un array -->
		<select id="codigos" name="selCodigosPostales[]" multiple="multiple" size="2" >
		...
		<input type="reset" value="Borrar datos" onclick="alert('Se borran todos los datos');" /> 
			...
			<input type="image" name="flecha" src="flechaverde.gif" width="30" height="30" title="Equivalente a submit" />
	</form>
