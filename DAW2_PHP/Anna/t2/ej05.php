...
<head> 
<style> 
span {  font-weight: bold;  font-size: x-large; }  
form {  display: inline; }  fieldset {  width: 300px;  display: inherit; }  
...
<input type="hidden" id="ocultoVacio" /><br />    
<!--<label for="ocultoLleno">Oculto lleno</label>-->
<input type="hidden" id="ocultoLleno" value="sorpresa" />
<br />    
<input type="submit" value="Enviar datos" />   
</fieldset>  </form>  
...
<textarea id="comentarios" rows="3" cols="40">
</textarea>    
<br/>    
<input type="submit" value="Enviar datos" />   
</fieldset>  
...
<input type="radio" name="radio" id="radioVerde" />
<label for="radioNaranja">Naranja</label>
<input type="radio" name="radio" id="radioNaranja" />
<label for="radioRojo">Rojo</label>
<input type="radio" name="radio" id="radioRojo" />
<br />    
<input type="submit" value="Enviar datos" />  
 </fieldset>  
 </form>  
 ...
 <input type="radio" name="genero" id="generoH" />
 <label for="generoO">Otro</label>
 <input type="radio" name="genero" id="generoO" />
 <br />    
 <input type="submit" value="Enviar datos" />   
 </fieldset>  
 </form> 
 ...
 <legend>Formulario 6</legend>   
  <label for="cabelloM">Moreno</label>
  <input type="radio" name="cabello" id="cabelloM" value="moreno" />
  <label for="cabelloR">Rubio</label>
  <input type="radio" name="cabello" id="cabelloR" value="rubio" />
  <label for="cabello">Pelirrojo</label>
  ...
  <input type="submit" value="Enviar datos" />   
    ...
    <label>Moreno</label>
    <input type="radio" /><label>Rubio</label>
    <input     type="radio" />
...
<!--------------------------------->  
      ...
      <input     type="checkbox" name="checkAficion" id="checkAficion" />
      <label     for="checkAficion">Viajes</label><input type="checkbox"     name="checkAficion" id="checkAficion" />
      <br />    
      <input type="submit" value="Enviar datos" />   
      </fieldset>  </form>  <form name="f9" method="get">   
      <fieldset>    
      ...
      <label     for="checkViajes">Viajes</label><input type="checkbox"     name="checkViajes" id="checkViajes" />
      <br />    <input type="submit" value="Enviar datos" />   
      </fieldset>  
      </form>  <form name="f10" method="get">   
      <fieldset>    <legend>Formulario 10</legend>    
      <label for="checkLectura">Lectura</label>
      ...
      ><input type="checkbox"     name="checkViajes" id="checkViajes" value="viajes" />
      <br />    <input type="submit" value="Enviar datos" />   
      </fieldset>  </form>  <form name="f11" method="get">   
      <fieldset>    <legend>Formulario 11</legend>    
      <label>Lectura</label><input type="checkbox" name="checkAficiones[]" value="lectura"/>  
        <label>Deporte</label><input type="checkbox" name="checkAficiones[]" value="deporte" />   
         <label>Viajes</label><input type="checkbox" name="checkAficiones[]" value="viajes" /><br />    
         <input type="submit" value="Enviar datos" />   
         </fieldset>  
         </form> 
         </body> 
