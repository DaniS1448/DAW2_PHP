...
if (isset ( $_REQUEST ['selCodigosPostales[]'] )) {
    $tamanioSelectPostales = sizeof ( $_REQUEST ['selCodigosPostales'] );
    for($i = 0; $i < $tamanioSelectPostales; $i ++) { // se recorre el array de checkboxes
...
<br />Idiomas: 
<?php echo $idiomas; ?> 
<br />A&ntilde;o de fin de estudios: 
<?php echo $anioFinEstudios; ?> 
<br />C&oacute;digos postales de provincias: 
