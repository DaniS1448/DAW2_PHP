<?php
/*Dado un día, mes y año entre el 1 de enero de 1971 y la actualidad, mostrar el número de años,
 *  meses, días, horas, minutos y segundos transcurridos desde entonces hasta ahora 
 *  (no es necesario tener en cuenta años bisiestos, y se pueden considerar todos los meses 
...
while ($ano<1971 || $ano>date("Y",time())){
    echo "Introduce un año entre 1971 y 2019: ";
    fscanf(STDIN,"%d\n",$ano);
}
...
echo "Han transcurrido $difAnos años, $difMeses meses, $difDias días, $horas horas, $minutos minutos y $segundos segundos desde la fecha indicada";
?>
