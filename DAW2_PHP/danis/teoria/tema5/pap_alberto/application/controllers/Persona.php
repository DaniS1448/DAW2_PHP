...
class Persona extends CI_Controller
{
    ...
    public function cPost()
    {
        ...
        try {
            $this->persona_model->crearPersona($nombre,$idPaisNace,$idPaisReside,$idsAficionGusta,$idsAficionOdia);
            redirect(base_url() . 'persona/r');
        }
        catch (Exception $e) {
            session_start();
